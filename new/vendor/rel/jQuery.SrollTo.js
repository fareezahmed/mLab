...
/*
     ...
     INTERNET ARCHIVE ON 7:49:22 Mar 4, 2017.
...
/**
 * jQuery.ScrollTo
 * Copyright (c) 2007-2009 Ariel Flesler - aflesler(at)gmail(dot)com | /web/20170102055812/http://flesler.blogspot.com
 * Dual licensed under MIT and GPL.
 * Date: 5/25/2009
 *
 * @projectDescription Easy element scrolling using jQuery.
 * /web/20170102055812/http://flesler.blogspot.com/2007/10/jqueryscrollto.html
 ...
 * /web/20170102055812/http://flesler.blogspot.com/2007/10/jquerylocalscroll-10.html
 * @author Ariel Flesler
 * @version 1.2.7
 *
...
;(function( $ ){
	...
	// @see /web/20170102055812/http://flesler.demos.com/jquery/scrollTo/
...
/*!
	Colorbox 1.6.3
	license: MIT
	/web/20170102055812/http://www.jacklmoore.com/colorbox
*/
(function ($, document, window) {
	var
	// Default settings object.
	// See /web/20170102055812/http://jacklmoore.com/colorbox for details.
	defaults = {
		// data sources
		html: false,
		photo: false,
	...
	// /web/20170102055812/http://bugs.jquery.com/ticket/6724
	function winheight() {
	...
	function addBindings() {
		function clickHandler(e) {
			...
			// See: /web/20170102055812/http://jacklmoore.com/notes/click-events/
...
if (typeof expandableTakeoverSmallHeight != 'undefined' && typeof expandableTakeoverLargeHeight != 'undefined') {
  ...
  function setCookie(cookieName,cookieValue,nDays) {
    // function from /web/20170102055812/http://www.javascripter.net/faq/settinga.htm
    var today = new Date();
    var expire = new Date();
  ...
  function readCookie(cookieName) {
    // function from /web/20170102055812/http://www.javascripter.net/faq/readinga.htm
